...
from framework.stage import ItemEvent, ItemMask, ItemImage
...
class Library(GameStage):
    ...
    def create_initial_dialog(self, data):
        ...
        for dialog_data in data["items"][self.game.datastore.datamodel.level]:
    ...
    def create_contents(self, data):
        ...
        for content in data.contents[self.game.datastore.datamodel.level]:
            ...
            if icon.content in self.game.datastore.datamodel.backpack[self.game.datastore.datamodel.level - 1]:
